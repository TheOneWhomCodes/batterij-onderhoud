...
try:
    ...
    while True:
        ...
        if amount_found_ids == 1:
            ...
            MQTT_manager.publish_msg({"dataType":"april","tagId":found_ids[0]})
        else:
            ...
            MQTT_manager.publish_msg({"dataType":"april","tagId":tag})
    ...
    print("WE ARE SAVING TO THAT DAMN FILE OKAY",flush=True)
